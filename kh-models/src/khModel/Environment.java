...
public class Environment extends SimStateSweep {
	 ...
	 * KH Model parameters
	 */
	public boolean nonSpatialModel = true;//original non-spatial KH model
	public boolean replacement = true; //to turn on and off replacement in the Environment class
	...
	public double fMax = 50; //the # of frustration
	public int distance = 3; //the # of radius the agent will search on a date
	...
	public void makeAgentsSpatial() {
		for(int i=0;i<females;i++) {
			...
			f.dirx = random.nextInt(3)-1;
			f.diry = random.nextInt(3)-1;
		...
		for(int i=0;i<males;i++) {
			...
			//assign random movement
			m.dirx = random.nextInt(3)-1;
			m.diry = random.nextInt(3)-1;
	...
	//decides if we need the agents to be spatial.
